...
require.config({
  baseUrl: '/js',
  paths: {json:'vendors/json',history:'vendors/history',inflection:'vendors/inflection',jquery:'vendors/jquery',lodash:'vendors/lodash','jquery.spritefy':'vendors/jquery.spritefy'}
});
require( ['app/app'] );
